...
**Votes are separate** from rubric — optional public `Vote: up` (or abstain) in the review issue per [winner-selection.md](../../../governance/winner-selection.md). Rubric breaks persistent ties only.
