...
export const programProjects: ProgramProject[] = [
  {
    ...
    weeks: 'Week 1',
    summary:
      'Configure required tooling, establish the pull-request workflow, and complete orientation activities on Discord before cohort platforms are available.',
    description:
      'Week 1 focuses on preparation rather than project development. Participants confirm Cursor and Claude Code subscriptions, obtain write access to the cohort repository, and submit their first pull request to `hult-cohort-program`. Following the refund window, the cohort roster is finalized and Phase 1 begins.',
    voteWeek: false,
    schedule: {
    ...
    expectations: [
      ...
      'Attend live orientation sessions; refund window closes Friday at 17:00',
    ],
    submission: {
      repoPattern: '{repo}',
      ...
      deadlineNote: 'Cohort roster finalized September 12, following the week 1 refund window (Friday, 17:00)',
    },
  ...
  },
  {
    ...
    weeks: 'Weeks 2–4',
    summary:
      'Develop a project management platform that the cohort will use to track projects, tasks, and assignments for the remainder of the semester.',
    description:
      'Each participant builds and deploys a production project management platform. Submit a merged pull request to `{repo}` containing your deploy URL and supporting documentation. The selected submission becomes the live system for the cohort — supporting accounts for every enrolled participant, with real projects and deadlines. This is operational infrastructure, not a portfolio demonstration. Following review week, the submission with the most private votes operates the cohort project management stack through Phase 2.',
    voteWeek: true,
    schedule: {
    ...
    expectations: [
      ...
      'The submission with the most votes after review week is selected to operate the platform',
    ...
    submission: {
      ...
      deadlineNote: 'Pull request merged to main by Thursday week 4, 17:00 — unmerged pull requests are ineligible for review week',
    },
    reviews: {
      artifact:
        'Written review (GitHub issue titled `Review by @{you}`) on each peer repository, then a private vote on this platform',
      dueNote: 'Friday week 4, 14:00',
    },
    passGate: [
  ...
  },
  {
    ...
    submission: {
      ...
      deadlineNote: 'Pull request merged by Thursday week 6, 17:00',
    },
    reviews: {
      artifact: 'Written review (GitHub issue) per peer, then a private vote',
      dueNote: 'Friday week 6, 14:00',
    },
    passGate: [
  ...
  },
  {
    ...
    submission: {
      ...
      deadlineNote: 'Pull request merged by Thursday week 8, 17:00',
    },
    reviews: {
      artifact: 'Written review (GitHub issue) per peer, then a private vote',
      dueNote: 'Friday week 8, 14:00',
    },
    passGate: [
      'Merged submission pull request',
      '{peerCount}/{peerCount} written reviews',
  ...
  },
  {
    ...
    weeks: 'Weeks 9–11',
    summary:
      'Develop a learning application on a topic of your choice; success is measured by external user adoption.',
    description:
      'Participants select a subject area — algorithms, finance, language, interview preparation, or another topic — and develop a production learning application registered on the Ludwitt/Hult platform. The assessment criterion is verified external usage: a minimum of 25 external users recorded by the platform API on the deadline date. Self-reported metrics are not accepted. External user adoption determines whether the application meets the standard.',
    voteWeek: false,
    schedule: {
    ...
    submission: {
      ...
      deadlineNote: 'Pull request merged by Friday week 11 — metrics snapshot taken on that date',
    },
  ...
  },
  {
    ...
    weeks: 'Weeks 12–15',
    summary:
      'Develop a complete venture package: investor materials, business plan, and a production application with external users.',
    description:
      'Participants prepare a venture as they would for a startup: market research, business plan, investor materials, and a production application with a minimum of 25 verified external users — the same metric standard as Project 4. At least one documented investor engagement (pitch email, call, or meeting — redact personally identifiable information in the pull request) is required. The application may be built in any repository; pass-gate tracking is conducted through a merged proof-of-work pull request to `{repo}` containing deck paths, application URL, and metrics.',
    voteWeek: false,
    schedule: {
    ...
    submission: {
      ...
      deadlineNote: 'Pull request merged by Friday week 15',
    },
  ...
  },
  {
    ...
    submission: {
      ...
      deadlineNote: 'Upstream merge required before cohort completion',
    },
