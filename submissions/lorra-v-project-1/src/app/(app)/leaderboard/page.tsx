...
export default async function LeaderboardPage({
  ...
  return (
    <div className="relative -mx-4 -my-8 min-h-[calc(100dvh-3.5rem)] overflow-hidden px-4 py-8">
      <div
        className="pointer-events-none absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url(/images/spiral-galaxy-leaderboard.png)" }}
        aria-hidden
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(6,10,20,0.78) 0%, rgba(6,10,20,0.72) 40%, rgba(6,10,20,0.85) 100%)",
        }}
        aria-hidden
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl space-y-6">
            ...
            <Link
              ...
              className={`rounded-lg px-3 py-1.5 text-sm ${
                sort === f.key
                  ...
                  : "border border-[var(--line)] bg-[var(--bg)]/50 text-[var(--muted)] hover:text-[var(--ink)]"
              }`}
            >
              {f.label}
            </Link>
        ...
        <Panel className="overflow-x-auto border-[var(--line)]/80 bg-[var(--bg-elevated)]/90 p-0 backdrop-blur-sm">
