...
export type RateLimitResult = {
    limited: boolean;
    /** Milliseconds until the current window resets. Only meaningful when limited. */
    retryAfterMs: number;
};
/**
 ...
 */
export declare function hitRateLimit(store: Map<string, RateLimitState>, key: string, now: number, limit: number, windowMs: number): RateLimitResult;
/**
 ...
 */
export declare function evictExpired(store: Map<string, RateLimitState>, now: number, windowMs: number): void;
