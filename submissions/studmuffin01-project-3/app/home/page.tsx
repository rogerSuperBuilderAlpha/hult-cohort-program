...
export default function HomePage() {
  const publicCount = PEOPLE.filter((p) => p.privacy === "public").length;
        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[var(--ink-muted)]">
              Cohort-wide shipping signals — the studio in motion.
            </p>
          </div>
          <Link
            href="/live"
        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="space-y-4">
            <div className="border border-[var(--line)] bg-[var(--bg-elevated)] p-5">
              ...
              <p className="mt-1 text-sm text-[var(--ink-muted)]">
                enrolled profiles · {publicCount} public ·{" "}
                {PEOPLE.length - publicCount} private
              </p>
            </div>
